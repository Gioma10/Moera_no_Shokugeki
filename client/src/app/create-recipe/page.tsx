...
//     //   return;
//     // }
//     if (!isValid || ingredients.length < 2) {
...
//       <h2 className="text-5xl">Create a recipe</h2>
//       <motion.form
//         onSubmit={handleSubmit(onSubmit)}
//         animate={errorMessage ? shakeError() : undefined}
...
//         )}
//         <div
//           className={`flex ${errorMessage ? "justify-between" : "justify-end"}`}
//         >
//           {errorMessage && (
//             <span className="text-red-700">Find you error Bro...</span>
//           )}
//           {/* Arrow to go step 2  */}
//           {step === 1 && (
//             <div className="relative ">
